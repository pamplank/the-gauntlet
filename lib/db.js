...
export const supabaseAdmin = createClient(SUPABASE_URL, SERVICE_ROLE_KEY, {
  ...
  global: {
    // Supabase's REST calls go through Next.js's patched fetch, which
    // caches by default. Force every call fresh — this data must never
    // be served stale (admin session state, live results, etc).
